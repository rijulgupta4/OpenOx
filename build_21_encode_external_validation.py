...
TARGET = ROOT / "21_encode_external_validation.ipynb"
...
if not (PROJECT_ROOT / 'encode_external_validation.py').exists():
    PROJECT_ROOT = PROJECT_ROOT / 'phase0_staging'
sys.path.insert(0, str(PROJECT_ROOT))

from encode_external_validation import run_validation
