...
OUT = ROOT / "23_bold_recalibration_validation.ipynb"
...
nb.cells = [
    ...
    nbf.v4.new_code_cell("import os\nos.environ['MKL_THREADING_LAYER']='SEQUENTIAL'\nos.environ['MKL_NUM_THREADS']='1'\nos.environ['OMP_NUM_THREADS']='1'\nfrom pathlib import Path\nimport pandas as pd\nimport matplotlib.pyplot as plt\nfrom bold_recalibration_validation import run_validation\nfrom qa_bold_recalibration_validation import run_qa\nROOT=Path.cwd(); RESULTS=ROOT/'bold_recalibration_validation'"),
