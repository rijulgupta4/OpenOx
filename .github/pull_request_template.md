...
Describe the reproducibility, documentation, compatibility, or verified-defect change.
...
- [ ] This change does not introduce retrospective optimization or relabel BOLD updating as independent external validation.
- [ ] Any result-changing defect is documented with dependent artifacts and rerun scope.
